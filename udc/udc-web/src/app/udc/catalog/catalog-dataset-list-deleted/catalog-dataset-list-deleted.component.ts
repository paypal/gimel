...
@Component({
  selector: 'app-catalog-dataset-list-deleted',
  templateUrl: './catalog-dataset-list-deleted.component.html',
})
export class CatalogDatabaseListDeletedComponent implements OnChanges {
  ...
  loadDatasetsFromCatalog(pageInfo) {
    ...
    this.catalogService.getDeletedDataSetListPageable(this.datasetStr, this.systemName, this.typeName, this.page).subscribe(pagedData => {
