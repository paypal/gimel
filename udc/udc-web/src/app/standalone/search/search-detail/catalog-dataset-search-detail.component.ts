...
@Component({
  selector: 'app-catalog-search-dataset-detail', templateUrl: './catalog-dataset-search-detail.component.html', styleUrls: ['./catalog-dataset-search-detail.component.scss'],
})

export class CatalogDatasetSearchDetailComponent implements OnInit {
