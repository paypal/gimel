...
@Entity
@Table(name = "pc_schema_dataset_map")
public class SchemaDatasetMap implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @ApiModelProperty(notes = "The database generated dataset schema map ID")
    ...
    @ApiModelProperty(notes = "Object Type")
    ...
    @Transient
    private List<SchemaDatasetColumnMap> schemaDatasetColumns;
    ...
    public List<SchemaDatasetColumnMap> getSchemaDatasetColumns() {
        return this.schemaDatasetColumns;
    }

    public void setSchemaDatasetColumns(final List<SchemaDatasetColumnMap> schemaDatasetColumns) {
        this.schemaDatasetColumns = schemaDatasetColumns;
    }
    ...
    public SchemaDatasetMap() {

    }

    public SchemaDatasetMap(final long storageSystemId, final long storageDatasetId, final long providerId,
            final String objectType, final String objectName, final String containerName, final String objectComment,
    ...
    public SchemaDatasetMap(final long schemaDatasetMapId, final long storageSystemId, final long storageDatasetId,
            final long providerId, final String objectType, final String objectName, final String containerName,
    ...
    public String toString() {
        return "SchemaDatasetMap [schemaDatasetMapId=" + this.schemaDatasetMapId + ", storageSystemId="
                + this.storageSystemId + ", storageDatasetId=" + this.storageDatasetId + ", objectType="
                + this.objectType + ", objectName=" + this.objectName + ", containerName=" + this.containerName
                ...
                + this.updatedTimestamp + ", schemaDatasetColumns=" + this.schemaDatasetColumns + "]";
    }
