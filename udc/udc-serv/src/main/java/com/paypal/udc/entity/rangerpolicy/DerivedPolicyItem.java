...
public class DerivedPolicyItem implements Serializable {
    ...
    public DerivedPolicyItem(final long derivedPolicyId, final String accessTypes, final String users,
            final String groups, final String isActiveYN, final String createdUser, final String createdTimestamp,
