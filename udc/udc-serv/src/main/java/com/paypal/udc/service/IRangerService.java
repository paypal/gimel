...
public interface IRangerService {
    ...
    List<DerivedPolicy> getPolicyByPolicyLocations(String locations, String type, long clusterId, final String table,
    ...
    PolicyDiscoveryMetric addPolicyDiscoveryStatus(PolicyDiscoveryMetric policyStatus) throws ValidationError;

    PolicyDiscoveryMetric getRecentPolicyDiscoveryMetric(String discoveryType);
