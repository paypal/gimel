...
object GimelJsonProtocol extends DefaultJsonProtocol {
  ...
  implicit val schema: RootJsonFormat[ObjectSchema] = jsonFormat7(ObjectSchema)
  implicit val hiveSchema: RootJsonFormat[HiveObjectSchema] = jsonFormat7(HiveObjectSchema)
  implicit val objectSchemaInfo: RootJsonFormat[ObjectSchemaMapUpload] = jsonFormat9(ObjectSchemaMapUpload)
  implicit val objectSchemaOutput: RootJsonFormat[ObjectSchemaMapUploadOutput] = jsonFormat13(ObjectSchemaMapUploadOutput)
  implicit val objectSchema: RootJsonFormat[AutoRegisterObject] = jsonFormat11(AutoRegisterObject)
  ...
  implicit val containerObject: RootJsonFormat[ContainerObject] = jsonFormat9(ContainerObject)
  ...
  implicit val rawObjectSchemaMap: RootJsonFormat[RawObjectSchemaMap] = jsonFormat9(RawObjectSchemaMap)
  ...
  implicit val rawPagedObjectSchema: RootJsonFormat[PagedAutoRegisterObject] = jsonFormat9(PagedAutoRegisterObject)
