...
object GenericSerializerConfigs {
  // Options for Avro Deserializer
  val avroSchemaSourceKey: String = "gimel.serializer.avro.schema.source"
  val avroSchemaSourceUrlKey: String = "gimel.serializer.avro.schema.url"
  val avroSchemaSubjectKey: String = "gimel.serializer.avro.schema.subject"
  val avroSchemaStringKey: String = "gimel.serializer.avro.schema.string"
  val columnToDeserializeKey: String = "gimel.serializer.column.name"
